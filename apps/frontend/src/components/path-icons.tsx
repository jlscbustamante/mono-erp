...
const listIcon: Record<string, IconType | LucideIcon | null> = {
  ...
  [PATHS.erp.modulos.mercaderia.compraGroup.compra]: null,
  [PATHS.erp.modulos.mercaderia.compraGroup.report]: null,
  [PATHS.erp.modulos.mercaderia.compraGroup.main]: BiPurchaseTagAlt,
