...
import { mapKeyFilterIamRole } from '@/data/security/IamRole/const/mapKeyFilterIamRole'
...
export const FilterComponent: React.FC<{
  ...
  const optionsFilters = optionsKeyFilter(mapKeyFilterIamRole(keyFilter))
