...
import { mapKeyFilterIamUser } from '@/data/security/IamUser/const/mapKeyFilterIamUser'
...
export const FilterComponent: React.FC<{
  ...
  const optionsFilters = optionsKeyFilter(mapKeyFilterIamUser(keyFilter))
