...
import { optionsFilterPaymentFile } from '@/data/digitization/const'
...
export const FilterComponent: React.FC<{
  ...
  const optionsFilters = optionsKeyFilter(optionsFilterPaymentFile(keyFilter))
