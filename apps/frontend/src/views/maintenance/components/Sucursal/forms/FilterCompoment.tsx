...
import { mapKeyFilterTerminalPost } from '@/data/maintenance/TerminalPost/const/mapKeyFilterTerminalPost'
...
export const FilterComponent: React.FC<{
  ...
  const optionsFilters = optionsKeyFilter(mapKeyFilterTerminalPost(keyFilter))
