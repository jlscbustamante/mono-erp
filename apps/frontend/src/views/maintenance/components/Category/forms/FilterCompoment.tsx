...
import { mapKeyFilterCategory } from '@/data/category/const/mapKeyFiltertype'
...
export const FilterComponent: React.FC<{
  ...
  const optionsFilters = optionsKeyFilter(mapKeyFilterCategory(keyFilter))
