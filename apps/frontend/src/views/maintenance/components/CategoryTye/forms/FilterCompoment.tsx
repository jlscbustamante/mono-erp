...
import { mapKeyFilterType } from '@/data/category/const/mapkeyFilterCategoryType'
import { ITypeCategory } from '@/data/category/types'
import { OpFilter } from '@/data/types/Filters'
import { filterOption, optionsKeyFilter, safeAny, sliceText } from '@/utils'

export const FilterComponent: React.FC<{
  keyFilter: keyof ITypeCategory
  ...
  const optionsFilters = optionsKeyFilter(mapKeyFilterType(keyFilter))
