...
import { mapKeyFilterSupplier } from '@/data/maintenance/Supplier/const/mapKeyFilterSupplier'
...
export const FilterComponent: React.FC<{
  ...
  const optionsFilters = optionsKeyFilter(mapKeyFilterSupplier(keyFilter))
