...
import { mapKeyFilterParameter } from '@/data/maintenance/Parameters/const/mapKeyFilterParameter'
...
export const FilterComponent: React.FC<{
  ...
  const optionsFilters = optionsKeyFilter(mapKeyFilterParameter(keyFilter))
