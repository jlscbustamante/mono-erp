...
import { mapKeyFilterCostCenter } from '@/data/maintenance/CostCenter/const/mapKeyFilterCostCenter'
import { OpFilter } from '@/data/types/Filters'
import { filterOption, optionsKeyFilter, safeAny, sliceText } from '@/utils'

export const FilterComponent: React.FC<{
  keyFilter: keyof ICostCenter
  ...
  const optionsFilters = optionsKeyFilter(mapKeyFilterCostCenter(keyFilter))
