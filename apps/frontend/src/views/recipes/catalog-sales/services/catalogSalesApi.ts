...
import { CreateProductDto, CreateProductFlavorDto, CreateProductSizeDto, SyncProductWithSizesAndFlavorsDto } from '../../shared/dtos/Catalog.dto'
...
export const syncProduct = async (payload: SyncProductWithSizesAndFlavorsDto) => {
...
export const syncManyProductsWithSizes = async(products: SyncProductWithSizesAndFlavorsDto[]) =>{
    return baseUrl<CreateProductDto[]>('api/view/recipe/catalog-sales/products/add-many', {
        method: 'POST',
        body: products,
        useV2: true,
    })
...
export const syncManyFlavors = async(flavor:CreateProductFlavorDto[]) => {
    return baseUrl<CreateProductSizeDto[]>('api/view/recipe/catalog-sales/flavors/add-many', {
        method: 'POST',
        body: flavor,
        useV2: true,
    })
...
export const syncManySizes = async(size:CreateProductSizeDto[]) => {
    return baseUrl<CreateProductSizeDto[]>('api/view/recipe/catalog-sales/sizes/add-many', {
        method: 'POST',
        body: size,
        useV2: true,
    })
