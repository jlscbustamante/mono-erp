...
import { getFilterTypesForKey } from '@/data/requests/const'
import { IRequest } from '@/data/requests/types'
import { OpFilter } from '@/data/types/Filters'
import { filterOption, optionsKeyFilter, safeAny, sliceText } from '@/utils'

export const FilterComponent: React.FC<{
  keyFilter: keyof IRequest
  ...
  const optionsFilters = optionsKeyFilter(getFilterTypesForKey(keyFilter))
