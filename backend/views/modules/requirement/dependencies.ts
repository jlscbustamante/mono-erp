...
import { RequirementExportService } from "#app/modules/requirement/requirement-export.service.ts";
...
export const requirementExportService = new RequirementExportService();
