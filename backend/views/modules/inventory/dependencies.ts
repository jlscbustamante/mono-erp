import { DeleteDispatch } from "#app/modules/inventory/case/delete_dispatch.ts";
...
import { UpdateDispatched } from "#app/modules/inventory/case/udpate_dispatched.ts";
...
export const delete_dispatch_uc = new DeleteDispatch();
export const update_dispatched_uc = new UpdateDispatched();
